...
class SpeechRecognitionApp(tk.Tk):
    ...
    def speak_response(self, text):
        ...
        self.after(1000, self.fade_out_response_text)  
    ...
    def start_wake_word_detection(self):
        ...
        if self.wake_word_thread is not None:
            self.wake_word_thread_stop_event.set() 
    ...
    def fade_in_listening_text(self):
        ...
        def fade():
            ...
            if new_color != '#ffffff':  
                ...
                self.listening_text.after(5000, self.check_silence)  
